    ...
    if request.method == "POST":
        ...
        try:
            ...
            if label_name == 'Tidak ada DR (Tidak ada Retinopati Diabetes)':
                ...
                message = ["Lakukan konsultasi ke Dokter. Lakukan Kontrol Kadar Gula Darah Secara Berkala. Kadar gula yang terkontrol adalah kunci utama dalam mengelola diabetes."]
